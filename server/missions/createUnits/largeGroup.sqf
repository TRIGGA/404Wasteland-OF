...
//Grenadier
_man15 = _group createunit ["TK_Special_Forces_TL_EP1", [_pos select 0, (_pos select 1) - 80, 0], [], 0.5, "Form"];
...
//Sniper
_man16 = _group createunit ["TK_Special_Forces_EP1", [_pos select 0, (_pos select 1) + 80, 0], [], 0.5, "Form"];
